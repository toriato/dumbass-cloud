...
def create_ui():
    ...
    with gr.Blocks(analytics_enabled=False) as extras_interface:
        ...
        submit.click(
            ...
            inputs=[
                ...
                dummy_component,
                extras_image,
                dummy_component,  # image_batch,
                dummy_component,  # extras_batch_input_dir,
                dummy_component,  # extras_batch_output_dir,
                dummy_component,  # show_extras_results,
                gfpgan_visibility,
                codeformer_visibility,
                codeformer_weight,
                upscaling_resize,
                dummy_component,  # upscaling_resize_w,
                dummy_component,  # upscaling_resize_h,
                dummy_component,  # upscaling_crop,
                extras_upscaler_1,
                extras_upscaler_2,
    ...
    with gr.Blocks(css=css, analytics_enabled=False, title="Stable Diffusion") as demo:
        with gr.Row(elem_id="serverinfo"):
            gr.Markdown(
                value='''
                [아카라이브 AI그림 채널 사용자](https://arca.live/b/aiart)를 위한 서버입니다
                <br>오류 또는 기능 추가 문의는 [@애옹이도둑](https://arca.live/u/@애옹이도둑) 또는 디스코드 **aeon#4285** 로 부탁드립니다
                <br>성능 향상을 위해 진행 상태는 보이지 않습니다
                ''')
